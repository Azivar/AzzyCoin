...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s azzycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  azzycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded azzycoin transaction") + "\n" +
              "  azzycoin-tx [options] -create [commands]   " + _("Create hex-encoded azzycoin transaction") + "\n" +
              "\n";
