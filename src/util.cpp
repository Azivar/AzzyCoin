...
const char * const BITCOIN_CONF_FILENAME = "azzycoin.conf";
const char * const BITCOIN_PID_FILENAME = "azzycoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Azzycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Azzycoin";
#else
    // Unix
    return pathRet / ".azzycoin";
#endif
#endif
}
